...
--esse (*) puxa todos os registros da tebela assim o individou nao precisa digitar todas as colunas ex:nome,codigo,categoria--
SELECT * FROM pokemons;

--selecionando os ataques e defesas dos pokemons--
SELECT ataque,especial_ataque,defesa,especial_defesa FROM pokemons;

--apresentar o nome ,categoria e ataque,dai o ataque tem que ser em ordem crescente,o (ASC) coloca em crescente--
SELECT nome,categoria,ataque FROM pokemons ORDER BY ataque ASC;

--Selecione altura, peso, com o cálculo do imc--
SELECT altura,peso,imc = (peso/(altura*altura)) FROM pokemons;

--Selecione altura, peso, com o cálculo do imc ordenando o imc em ordem decrescente dai usa o (DESC) que vai ser por decrescente--
SELECT altura,peso,imc = (peso/(altura*altura)) FROM pokemons ORDER BY imc DESC;

--Selecione nome e o tamanho do nome em ordem decrescente pelo nome--
SELECT nome, LEN(nome) FROM pokemons ORDER BY nome DESC;
